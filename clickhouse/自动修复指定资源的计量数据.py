...
pipe_list = ['7445e1f0-17ae-11ed-9c40-dad0c2cb90d1', 'adef470e-cd33-11e7-b0c5-0242ac110002']
...
def add_data(conn_info, pipe_id):
    ...
    start_time = datetime(2022, 9, 6, 12, 00, 00)
    ...
    end_time = datetime(2022, 9, 7, 14, 00, 00)
    fix_list = []
