...
client.execute("SELECT time, in_bps, out_bps FROM flow_snmp.flow_data where pipe_id  = '272ee83e-b33a-11e9-833f-0242ac110002' order by time limit 1")
client.execute("SELECT count(*) FROM flow_snmp.flow_data where pipe_id  = 'e94da578-6f97-11ed-a9fe-2297c76c4e4d'")
